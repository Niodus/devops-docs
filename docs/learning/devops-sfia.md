...
Influencing stakeholder attitudes, decisions, and actions for mutual benefit. Activities may include — but are not limited to:
...
Tooling examples: Jenkins, Argo, GitHub, GitLab, Azure DevOps, etc.
